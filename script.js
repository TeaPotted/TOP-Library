...
class Book {
  constructor (title, author, pages, read) {
    ...
    this.pages = pages;
    this.read = read;
    this.id = crypto.randomUUID(); // set id to a random unique id
  }
...
function addBookToLibrary(title, author, pages, read) {
  ...
  const book = new Book(this.title, this.author, this.pages, this.read); // create a book with the parameters
  myLibrary.push(book); // then push the book to myLibrary
};
